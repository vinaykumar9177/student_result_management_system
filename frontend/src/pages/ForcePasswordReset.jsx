    ...
    return (
      <div className="flex min-h-screen items-center justify-center p-4">
        <div className="glass-panel w-full max-w-md p-8 text-center space-y-4">
          ...
          <p className="text-sm text-slate-500">You must be logged in to reset your password.</p>
    ...
    <div className="flex min-h-screen items-center justify-center p-4 md:p-8">
      <div className="w-full max-w-md animate-slide-up">
        <form className="glass-panel w-full space-y-5 p-8" onSubmit={handleSubmit}>
          <div>
            <div className="flex items-center gap-2 text-red-600 bg-red-50 border border-red-100 rounded-xl px-3 py-2 text-xs font-semibold">
              <ShieldAlert className="h-4 w-4 shrink-0" />
              <span>Forced Password Change Required</span>
            </div>
            <h1 className="mt-4 text-2xl font-extrabold tracking-tight text-slate-900">Choose a new password</h1>
