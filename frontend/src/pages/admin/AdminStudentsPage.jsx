...
export default function AdminStudentsPage() {
  ...
  return (
    <div className="space-y-6">
      ...
      {/* Tabs */}
      <div className="flex gap-2 border-b border-slate-200/60 pb-px">
        {[
        ...
        <div className="space-y-4">
          {loading ? (
            <div className="flex h-60 items-center justify-center">
              ...
              <span className="ml-3 text-slate-500 font-medium">Loading student list...</span>
            </div>
          ) : (
            <DataTable
              data={students}
              ...
              columns={[
                ...
                },
                {
                  ...
                  header: 'Sem',
                  render: (row) => <span className="font-medium text-slate-700">S{row.current_semester}</span>,
                },
                {
                  key: 'actions',
                  header: 'Actions',
      ...
      {activeTab === 'create' && (
        <div className="grid gap-6 md:grid-cols-3">
          ...
          <div>
            {tempPasswordInfo && (
              <div className="glass-panel p-6 border-emerald-200 bg-emerald-50/30 text-slate-700 animate-slide-up space-y-4">
        ...
        <div className="grid gap-6 md:grid-cols-3">
          <div className="md:col-span-2 space-y-6">
            <div className="glass-panel p-6">
              <h3 className="text-lg font-bold text-slate-800 mb-2">CSV Bulk Import</h3>
              <p className="text-sm text-slate-500 mb-4">
                Upload a CSV file containing headers: <code className="font-mono bg-slate-100 rounded px-1 text-slate-700">email, roll_number, name, department_id, course_id, current_semester</code>.
              </p>
            ...
            {bulkResult && (
              <div className="glass-panel p-6 space-y-4 animate-slide-up">
                <div className="flex items-center justify-between border-b border-slate-200/60 pb-3">
                  <h4 className="font-bold text-slate-800">Provisioning Report</h4>
                ...
                {bulkResult.errors.length > 0 ? (
                  <div className="space-y-2">
                    ...
                    <div className="max-h-48 overflow-y-auto rounded-xl border border-slate-200 bg-slate-50 p-3 text-xs font-mono text-slate-600 space-y-1">
          ...
          <div className="glass-panel p-6 space-y-4">
            <h4 className="font-bold text-slate-800">CSV Template Reference</h4>
            <div className="rounded-xl border border-slate-200 bg-slate-50 p-3 text-[11px] font-mono text-slate-600 overflow-x-auto">
      ...
      {editStudent && (
        <div className="fixed inset-0 z-50 flex items-center justify-center p-4">
          <div className="fixed inset-0 bg-slate-900/40 backdrop-blur-sm" onClick={() => setEditStudent(null)} />
          <div className="glass-panel relative z-10 w-full max-w-lg p-6 bg-white shadow-2xl animate-scale-up">
            <button
            ...
            <h3 className="text-lg font-bold text-slate-850 mb-4">Edit Student Account</h3>
            ...
            <form onSubmit={handleUpdate} className="space-y-4">
              ...
              <div className="flex gap-2 justify-end pt-4">
                ...
                <button type="submit" className="btn-premium py-2.5 text-sm">
                  Save Changes
                </button>
              </div>
            </form>
